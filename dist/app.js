 ...
 */
var setLotteryResult = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(users) {
        var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, user, el;
                ...
                switch (_context.prev = _context.next) {
                    ...
                    case 4:
                        ...
                        for (_iterator = users[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            user = _step.value;
                            el = document.querySelector('#lu' + user.id);
    ...
    return function setLotteryResult(_x) {
...
var $lottery = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref2, n) {
        ...
        var isMixed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

        var id, retweeters, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _retweeters, tweet, _users, users, _loop, i;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        // 対象のツイート ID
                        id = target.getAttribute('tweet-id');
                        ...
                        _context2.prev = 7;
                        for (_iterator2 = app.$data.tweets[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            tweet = _step2.value;

                            (_retweeters = retweeters).push.apply(_retweeters, _toConsumableArray(tweet.retweeters));
                        }
                        //
                        _context2.next = 15;
                        break;
                    ...
                    case 33:
                        ...
                        _loop = function _loop(i) {
                            ...
                            // 当選者
                            var retweeter = lottery(retweeters);

                            // 対象者一覧から除外
                            retweeters = retweeters.filter(function (_ref4) {
                                var id = _ref4.id;
    ...
    return function $lottery(_x3, _x4) {
...
var _tweet = __webpack_require__(334);

var _tweet2 = _interopRequireDefault(_tweet);

var _vueComponents = __webpack_require__(335);
...
function getLotteryTargetRetweeters(id) {
    ...
    var retweeters = [].concat(_toConsumableArray(tweet.retweeters));

    var _tweet$view = tweet.view,
        ffRatioCheck = _tweet$view.ffRatioCheck,
        ffRatioBorder = _tweet$view.ffRatioBorder,
        followerCountCheck = _tweet$view.followerCountCheck,
        followerCountBorder = _tweet$view.followerCountBorder;
    ...
    if (ffRatioCheck && ffRatioBorder !== null) {
        ...
        var border = parseFloat(ffRatioBorder);
...
app = new _vue2.default({
    ...
    methods: {
        ...
        openLotteryDialog10: function openLotteryDialog10(e) {
            $lottery(e, 10);
        },
        openLotteryDialog: function openLotteryDialog(e) {
            $lottery(e, 1);
        }
    },
...
$('#open-spreadsheet').on('shown.bs.modal', function () {
    $('#myInput').focus();
});
...
function updateOembeds() {
    ...
    try {
        for (var _iterator4 = document.querySelectorAll('.twitter-tweet')[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            var el = _step4.value;
...
socket.on('spreadsheet-end', function () {
    app.$data.modals.spreadsheet.done = true;
});

function getTweet(id) {
    return app.$data.tweets.filter(function (tweet) {
        return tweet.id === id;
    })[0];
}
...
exports.default = createVueComponents;

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function createVueComponents(Vue) {
    ...
    Vue.component('app-graph', {
        ...
        created: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var app, context, id, tweet, retweeters, counts, chart;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                            ...
                            case 3:
                                ...
                                id = this.$el.getAttribute('tweet-id');
                                tweet = app.$data.tweets.filter(function (tweet) {
                                    return tweet.id === id;
                                })[0];
                                _context.next = 8;
                                return new Promise(function (resolve) {
                            ...
                            case 8:
                                ...
                                counts = Array.from({ length: 24 }).fill(0);
