...
async function $lottery(_ref, n) {
    ...
    if (isMixed) {
        ...
        try {
            for (var _iterator2 = app.$data.tweets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var _retweeters;
    ...
    var _loop = function _loop(i) {
        ...
        // 対象者一覧から除外
        retweeters = retweeters.filter(function (_ref2) {
            var id = _ref2.id;
...
app = new _vue2.default({
    ...
    methods: {
        ...
        // スプレッドシートに書き込む
        writeSpreadsheet: function writeSpreadsheet(_ref3) {
...
socket.on('observe-tweets', async function (tweets) {
    ...
    try {
        ...
        for (var _iterator3 = tweets[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
